...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblProducts.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent evt) {
                tblProductsComponentShown(evt);
            }
        });
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
     ...
     if(row<0)
     {
         JOptionPane.showMessageDialog(this, "Please select a row to view product details");
         return;
    }
     
     Product selectedProduct=(Product) tblProducts.getValueAt(row, 0);
     
     ViewProductDetailJPanel vpdjp=new ViewProductDetailJPanel(workArea, selectedProduct, "View");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        SearchForProductJPanel searchproductPanel=new SearchForProductJPanel(workArea, supplier);
        workArea.add("SearchProductPanel", searchproductPanel);
        CardLayout layout=(CardLayout) workArea.getLayout();
        layout.next(workArea);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int row=tblProducts.getSelectedRow();
        if(row<0)
            JOptionPane.showMessageDialog(this, "Select a product to delete it");
    ...
    private void tblProductsComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_tblProductsComponentShown
        // TODO add your handling code here:
            imgLogo.setIcon(supplier.getLogoImage());
    }//GEN-LAST:event_tblProductsComponentShown
