...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewProductDetailJPanel(JPanel workArea, Product product, String page) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbPreFeature = new javax.swing.JComboBox<>();
        lbPreFeature = new javax.swing.JLabel();
        lbChoice = new javax.swing.JLabel();
        ...
        cmbPreFeature.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vendor", "Batch no."}));
        cmbPreFeature.setEnabled(false);

        lbPreFeature.setText("Select the feature here:");

        lbChoice.setText("Do you want to add more features?");

        cmbChoice.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "No", "Yes"}));
        cmbChoice.setEnabled(false);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(lbChoice)
                                    .addComponent(lbPreFeature))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(cmbPreFeature, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(btnAdd)))
                                    .addComponent(cmbChoice, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(23, 23, 23)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbPreFeature, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lbPreFeature)
                    .addComponent(btnAdd))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        cmbChoice.setEnabled(true);
        cmbPreFeature.setEnabled(true);
    ...
    private void backButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButton1ActionPerformed
        ...
        //SearchForProductJPanel.refreshTable();
        //workArea.add("ManageProductCatalog",manageProductCatalogJPanel);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        Feature newFeature = product.addNewFeature();
        newFeature.setName(cmbPreFeature.getSelectedItem().toString());
        newFeature.setValue("Type Value here");
    ...
    private void cmbChoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbChoiceActionPerformed
        ...
        if(cmbChoice.getSelectedItem().toString().equals("Yes"))
            btnAddFeature.setEnabled(true);
    ...
    private javax.swing.JComboBox<String> cmbPreFeature;
    private javax.swing.JLabel imgLogo;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JLabel lbChoice;
    private javax.swing.JLabel lbPreFeature;
